...
$clusterName = "crmrcluster"
$clusterUsername = "admin"
$clusterPassword = "Password11)"

#Azure Blob storage (WASB) variables
$storageAccountName = "crmrstorage"
$storageContainerName = "crmrcluster"
...
$hiveScript = "$oozieWFPath/opportunityquery.hql"
...
# start Oozie job - Only need to start the job if you are submitting it once to run
